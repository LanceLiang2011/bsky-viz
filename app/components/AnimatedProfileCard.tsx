...
const AnimatedProfileCardComponent: React.FC<AnimatedProfileCardProps> = ({
  ...
  return (
    <div
      ref={wrapRef}
      className={`apc-card-wrapper ${className}`.trim()}
      style={cardStyle}
    >
      <section ref={cardRef} className="apc-card">
        <div className="apc-inside">
            ...
            {showUserInfo && (
              <div className="apc-user-info">
                ...
                <div className="apc-user-details">
                  ...
                  <div className="apc-user-text">
                    <div className="apc-handle">@{handle}</div>
                    <div className="apc-status">{status}</div>
                  </div>
                </div>
                <button
                  className="apc-contact-btn"
          ...
          <div className="apc-content">
            <div className="apc-details">
              {identityLabel && (
                <div className="apc-identity-label">{identityLabel}</div>
              )}
              <h3>{name}</h3>
              <p>{title}</p>
            </div>
...
const AnimatedProfileCard = React.memo(AnimatedProfileCardComponent);
