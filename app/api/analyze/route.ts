...
const FIELD_PROMPTS = {
  en: {
    summary:
      "Write a comprehensive personality profile (aim for 250-300 words) that analyzes this person's unique characteristics across multiple dimensions. Structure your analysis to distinguish between their original thoughts and conversational patterns:\n\n1. CORE PERSONALITY (from original posts)\n\n2. SOCIAL DYNAMICS (from replies)\n\n3. BEHAVIORAL PATTERNS\n\nFocus on specific examples from their content that reveal deeper personality insights, emotional patterns, and unique characteristics that set them apart. Create a thorough and insightful analysis that captures their distinctive behavioral fingerprint.",
    animalSelection:
